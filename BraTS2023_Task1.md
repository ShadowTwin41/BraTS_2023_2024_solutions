...
## [BraTS 2023 - Task 1 - Adult Glioma Segmentation](https://www.synapse.org/Synapse:syn51156910/wiki/622351)
...
The submitted methods will be assessed using the Lesion-wise Dice Similarity Coefficient and the Lesion-wise Hausdorff distance (95%).
...
On this page we will go through the generation of synthetic data using GANs. For the registration part, please have a look at the paper.
...
**Run the training (run for all 5 folds):**
